...
class AspectualLinearity extends PathInfo {
  ...
  @Test def testSimpleTradeAuthentication() {
    ...
    assertFalse(AspectualLinearity(protocol, aspects(0)))
  }
  ...
  @Test def testSimpleTradeAuthWithChoice() {
  ...
  @Test def testSimpleTradeChoiceWithSameMessageAtBothBranchesButNotFirst() {
